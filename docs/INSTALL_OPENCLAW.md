...
Receipt reuse now fails closed unless the persisted receipt includes and matches the requested positive run on `thesis_id`, `run_id`, `contract_version`, and `alert_artifact_id`.
