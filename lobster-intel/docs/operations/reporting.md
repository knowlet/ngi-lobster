...
- rejects runtime contract verification when a delivery receipt omits `alert_artifact_id` or `contract_version`, or points at a different alert artifact / contract version than the run being audited
